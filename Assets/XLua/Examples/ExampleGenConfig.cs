...
public static class ExampleGenConfig
{
    ...
    public static List<Type> LuaCallCSharp = new List<Type>() {
                ...
                typeof(PPEffects.Anaglyph3D),
                typeof(PPEffects.CircularBlur),
                typeof(PPEffects.Colorization),
                typeof(PPEffects.Drunk),
                typeof(PPEffects.DuoTone),
                typeof(PPEffects.Emboss),
                typeof(PPEffects.Greyscale),
                typeof(PPEffects.Laplacian),
                typeof(PPEffects.Lens),
                typeof(PPEffects.Negative),
                typeof(PPEffects.NightVision),
    ...
    public static List<List<string>> BlackList = new List<List<string>>()  {
                ...
                new List<string>(){"UnityEngine.Rendering.PostProcessing.RuntimeUtilities", "isSinglePassStereoSelected"},
            };
}

...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAINavMeshModifierVolumeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.AI.NavMeshModifierVolume);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.AI.NavMeshModifierVolume gen_ret = new UnityEngine.AI.NavMeshModifierVolume();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.AI.NavMeshModifierVolume constructor!");
        ...
        static int _m_AffectsAgentType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshModifierVolume gen_to_be_invoked = (UnityEngine.AI.NavMeshModifierVolume)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_activeModifiers(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, UnityEngine.AI.NavMeshModifierVolume.activeModifiers);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;

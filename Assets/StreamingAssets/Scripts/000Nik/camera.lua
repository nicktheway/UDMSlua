...
function start()
	...
	CF.setTargetGroup(Room, 'dancers')
...
function myInit()
	CF.setActiveCamera('dolly')
	CF.setAutoDolly(false)
	CF.setDollyPath('haha')
end

function myUpdate()
	CF.setPathPos(UT.unpackVector3(groupDomain.Members[0].transform.position))
	CF.setPosOnPath(TIME*0.03)
end

...
function start()
    ...
    for i=0,Nagn - 1 do
		...
		s[i]=math.random(0,1)
		LFG.setPos(i,UE.Vector3(6*math.cos(i*6.28/Nagn),0,6*math.sin(i*6.28/Nagn)))
...
function updateState(n)
	if n==1 then updateState01() 
	elseif n==11 then updateState11() 
	elseif n==12 then updateState12() 
	elseif n==13 then updateState13() 
	elseif n==14 then updateState14() 
	end
end

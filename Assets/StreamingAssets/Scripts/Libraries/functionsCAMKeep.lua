...
function setUpDefaultCamera(luaCamera)
	...
	function M.stateUpdate(TIME, state)
		...
		if state==1 then M.update1(TIME)
		elseif state == 2 then M.update2(TIME)
		elseif state == 3 then M.update3(TIME)
		elseif state == 4 then
		elseif state == 5 then M.update5(TIME)
		elseif state == 6 then
		elseif state == 7 then
		elseif state == 8 then
		elseif state == 9 then

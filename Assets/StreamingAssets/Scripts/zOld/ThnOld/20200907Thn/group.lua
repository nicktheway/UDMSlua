...
function update()
    TIME = TIME + 1
	Xtras.printOnScreen(math.sin(TIME/10), 10, 10, UE.Color.green)
...
function agentStart(i)
		...
		local trail = require('extras').attachTrailRenderer(Members[i].gameObject)
		trail.time=30
